...
class Field:
    ...
    def remove_animal(self,position):
        return self.__animals.pop(position)
    ...
    def grow(self,light,food,water):
        ...
        if len(self._animals) > 0:
            ...
            #if we have more food available than required, work out the additional available
            ...
            for animal in self._animals:
                ...
                #see if there is any additional food to give to animal
...
def manual_grow(field):
    #get the light water and food values from the use
    valid = False
    while not valid:
        try:
