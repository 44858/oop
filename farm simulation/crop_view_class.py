...
from crop_resources_py import *

class CropView(QGraphicsView):
    """this class provides a graphics view that has the resources for displaying the crops visually"""
    ...
    def resources(self, crop_type):
        ...
        self.setScene(self.crop_scenes[0]) #set the intial scene
